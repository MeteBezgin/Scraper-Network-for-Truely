    ...
    return page
      ...
      .then(async (e) => {
        let data = await page.evaluate(() => {
          b = [];
          let authors = document.querySelectorAll("div.review-author");
          let reviewtexts = document.querySelectorAll("div.review-summary");
          let ratings = document.querySelectorAll("span.review-score");
          for (i = 0; i < authors.length; i++) {
            let author = authors[i].textContent.trim();
            let reviewtext = reviewtexts[i]
              .querySelector("div.toggle-content")
              .textContent.replaceAll("...Read More ", "")
              .replaceAll("Less", "")
              .trim();
